...
public class DetalhesJogoPanel extends JPanel {
    ...
    private void init() {
        ...
        scrollPane2.getVerticalScrollBar().setBlockIncrement(30);
...
//            voltarButton.putClientProperty(FlatClientProperties.STYLE, "foreground:#FFFFFF");
    ...
    private JPanel criarBlocoNotaUsuario(Nota nota) {
        ...
        JLabel usuarioLabel = new JLabel("Usuário: " + ((Usuario)controleUsuario.buscarPorId(nota.getIdUsuario())).getUsuario());
